FARSITE-Compatible Features Implementation
===========================================
...
.. list-table:: Fire Intensity Classes
   :header-rows: 1
   :widths: 10 20 20 50
...
where :math:`r_{\text{fire}} = \sqrt{A_{\text{burned}} / \pi}`

* Global scaling based on current fire size
* Simple and computationally efficient
* Fire achieves ~63% of QSS at :math:`r_{\text{fire}} = L_{\text{acc}}`, ~95% at :math:`r_{\text{fire}} = 3 \times L_{\text{acc}}`
