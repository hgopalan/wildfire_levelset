Fire Acceleration Model Implementation
=======================================
...
3. The model uses :math:`R(t) = R_E \times (1 - \exp(-A \times t))` with per-cell temporal tracking
