...
- `historical_wildfires.py` – Query and generate simulation inputs for 19+ major historical wildfires; automatic terrain generation via SRTM with configurable lat/lon bounds
