...
**Fire Spread Models**: Rothermel (1972) • FARSITE elliptical expansion • Alternative models (Balbi, Cheney-Gould, Cruz, Canadian FBP, Lautenberger) • Two-fuel blending

**Fire Behavior**: Crown fire initiation & spread • Wind-terrain-fuel interactions • Radiation preheating • Fire acceleration (Anderson) • Crown Fire Surface Area (CFSA) • Backing fire ROS

**Fuel Moisture**: Time-varying schedules • Diurnal cycles • Precipitation wetting • Canadian FWI System (FFMC/DMC/DC/BUI/FWI) • Duff moisture & smoldering • Time-lag differential equations

**Fire Danger Indices**: Keetch-Byram Drought Index (KBDI) • Haines Index • McArthur FFDI • Canadian FWI System • NFDRS components

**Spotting**: Albini trajectory model • Ember cascade & accumulation • Probabilistic ignition

**Weather & Terrain**: LCP terrain support • Multi-station interpolation • Turbulent wind models • Multi-layer canopy wind profile
