# Catchpole & de Mestre (1986) Double-Ellipse Shape Test
# Tests: double-ellipse fire shape model with origin at fire front
...
# Catchpole & de Mestre double-ellipse shape
